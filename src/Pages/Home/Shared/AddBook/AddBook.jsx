        ...
        <div className="max-w-4xl mx-auto p-8 bg-white shadow-xl rounded-lg">
            ...
            <form onSubmit={handleSubmit(handleAddBook)} className="space-y-6">
                ...
                <div className="form-control">
                    ...
                    />
                    {errors.bookName && <span className="text-red-500 text-sm">Book name is required</span>}
                </div>
                ...
                <div className="form-control">
                    ...
                    />
                    {errors.bookAuthor && <span className="text-red-500 text-sm">Author is required</span>}
                </div>
                ...
                <div className="form-control">
                    ...
                    />
                    {errors.bookImage && <span className="text-red-500 text-sm">Book image is required</span>}
                </div>
                ...
                <div className="form-control">
                    ...
                    />
                    {errors.price && <span className="text-red-500 text-sm">Price is required and must be positive</span>}
                </div>
