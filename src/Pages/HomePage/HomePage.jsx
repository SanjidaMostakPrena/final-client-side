...
//       {/* 2. Features Section */}
//       <section className="py-20 px-6 md:px-24 bg-gray-50 dark:bg-gray-800">
...
//             <p>Get books delivered within 24-48 hours safely to your doorstep.</p>
//           </div>
//           <div className="p-6 bg-white dark:bg-gray-700 rounded-2xl shadow hover:shadow-2xl transition">
//             <div className="text-4xl mb-4">📚</div>
//             <h3 className="text-xl font-semibold mb-2">Wide Selection</h3>
//             <p>Thousands of books across genres, curated from trusted libraries.</p>
//           </div>
//           <div className="p-6 bg-white dark:bg-gray-700 rounded-2xl shadow hover:shadow-2xl transition">
//             <div className="text-4xl mb-4">💡</div>
//             <h3 className="text-xl font-semibold mb-2">Knowledge Growth</h3>
//             <p>Boost learning, explore classics, and discover new interests.</p>
//           </div>
//         </div>
//       </section>
...
//         <h2 className="text-4xl font-bold text-center mb-12">Book Categories</h2>
//         <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
//           {["Fiction", "Non-Fiction", "Children", "Sci-Fi", "Biographies", "Tech", "History", "Poetry"].map((cat, idx) => (
//             <div key={idx} className="bg-gradient-to-br from-indigo-100 to-teal-50 dark:from-gray-700 dark:to-gray-600 rounded-xl p-6 text-center hover:scale-105 transition-transform cursor-pointer">
...
//         <h2 className="text-4xl font-bold mb-12">Why Choose BookCourier?</h2>
//         <div className="grid md:grid-cols-4 gap-10 max-w-6xl mx-auto">
//           <div>
//             <p className="text-5xl font-bold text-teal-500">64+</p>
//             <p className="mt-2">Districts Covered</p>
//           </div>
//           <div>
//             <p className="text-5xl font-bold text-indigo-500">2000+</p>
//             <p className="mt-2">Books Delivered</p>
//           </div>
//           <div>
//             <p className="text-5xl font-bold text-teal-500">150+</p>
//             <p className="mt-2">Trusted Libraries</p>
//           </div>
//           <div>
//             <p className="text-5xl font-bold text-indigo-500">98%</p>
...
//           ].map((t, i) => (
//             <div key={i} className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow hover:shadow-2xl transition">
//               <p>"{t.text}"</p>
...
//           ].map((faq, i) => (
//             <div key={i} className="p-6 bg-gray-100 dark:bg-gray-700 rounded-xl shadow">
...
//       {/* 9. Newsletter Signup */}
//       <section className="py-20 px-6 md:px-24 bg-white text-black text-center rounded-xl mx-6 md:mx-24">
//         <h2 className="text-3xl md:text-4xl font-bold mb-4">Subscribe for Updates</h2>
//         <p className="mb-6">Get notified about new books, offers, and events.</p>
...
//           />
//           <button className="bg-teal-500 hover:bg-teal-600 px-6 py-3 rounded-lg font-semibold transition">
//             Subscribe
//           </button>
//         </form>
//       </section>
