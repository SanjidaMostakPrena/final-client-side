  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {books.map(book => (
          <div key={book._id} className="shadow-lg rounded-xl p-4 border hover:shadow-xl transition">
            <img src={book.image} alt={book.title} className="w-full h-56 object-cover rounded-lg" />
