...
const MyOrders = () => {
  ...
  const handleCancel = async (orderId) => {
    console.log("Stripe session data:", orderId);
    try {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10 bg-white rounded-2xl shadow-lg text-black">
      <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-black">
        My Orders
      </h2>

      {orders.length === 0 ? (
        <p className="text-center text-gray-800 text-lg">No orders found.</p>
      ) : (
        <div className="overflow-x-auto">
          <table className="table w-full border border-gray-300 rounded-xl shadow-md bg-white text-black">
